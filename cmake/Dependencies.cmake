...
# Zstd - check for both possible target names
...
elseif(ZSTD_FOUND)
    message(STATUS "Zstd: Found (via ZSTD_FOUND)")
else()
...
elseif(nlohmann_json_FOUND)
    message(STATUS "nlohmann_json: Found (via nlohmann_json_FOUND)")
else()
...
elseif(blake3_FOUND)
    message(STATUS "BLAKE3: Found (via blake3_FOUND)")
else()
